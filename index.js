const {
  ...
  const sessdata = config.SESSION_ID.split("DULA-MD")[1];
  ...
  console.log('DULA-MD connected to whatsapp ✅')
  ...
  ║      • PREFIX: .            
  ╟─────────────────╢
  ║ ♻ ᴅᴀʀᴋ ɴᴏᴠᴀ xᴍᴅ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 🧑‍💻⚖         
  ║ https://chat.whatsapp.com/Ba8imiorZ0e9wdTB4Hbd5M              
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐋𝐈𝐍𝐊          
  ║ https://wa.link/vc0z09               
  ╠═════════════════╣
  ║      DULA-MD               
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴜʟᴀ
  ╠═════════════════╣
  ...
  ╚═════════════════╝
`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://ibb.co/VWVmMvwv` }, caption: up })
